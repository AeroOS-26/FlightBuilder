...
/**
 * Public Flight Detail — Filling State (Frame 11 + 11C variants)
 *
 * Displayed when group is filling (4+ members, but not full yet).
 * Variant of LoggedInFlightDetailPage with "Filling" status highlight.
 * Routes: /share/[token] (when logged in + group filling)
 *
...
export function FillingFlightDetailPage({
  token,
  flight,
  isAlreadyMember,
}: FillingFlightDetailPageProps) {
